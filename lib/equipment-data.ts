...
export const equipmentCategories: EquipmentCategory[] = [
  {
    ...
    items: [
      ...
      { id: "adjustable-splint", name: 'סד לקבוע מתכוונן', category: "bandages", maxQuantity: 1 },
      ...
      { id: "malach", name: 'מלע"כ', category: "bandages", maxQuantity: 1 },
      { id: "adjustable-neck-collar", name: "צווארון מתכוונן מבוגר", category: "bandages", maxQuantity: 1 },
